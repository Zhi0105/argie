...
export const Greet = () => {
  const {  setActiveRoute } = useRouteStore((state) => ({ //ROUTE STORE
      ...
      '>
        ...
        <motion.div 
          ...
          >
            ...
            <span className="absolute flex items-center justify-center w-full h-full text-white transition-all duration-300 transform group-hover:translate-x-full ease">Read more</span>
